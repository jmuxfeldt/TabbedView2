...
*   [Differences to older TabbedView](#Differences to older TabbedView)

*   [Class methods](#classmethods)

*   [new](#*new)
*   [Convenience Creation Methods](#Convenience Creation Methods)

*   [Inherited class methods](#Inherited class methods)
*   [Undocumented class methods](#Undocumented class methods)

*   [newIDEdefault](#*newIDEdefault)
...
*   [Adding, Removing, Dragging, and Detaching Tabs](#Adding, Removing, Dragging, and Detaching Tabs)

*   [add](#-add)
*   [insert](#-insert)
*   [dragTabs](#-dragTabs)
*   [detachedClosable](#-detachedClosable)
*   [demo](#-demo)
*   [removeAt](#-removeAt)
*   [focus](#-focus)
*   [activeTab](#-activeTab)

*   [Set tabPosition and followEdges](#Set tabPosition and followEdges)
...
*   [Examples: Set tabPosition and followEdges](#Examples: Set tabPosition and followEdges)

*   [Auto-Archiving a TabbedView2 State](#Auto-Archiving a TabbedView2 State)

*   [autoArchive](#-autoArchive)
*   [archiveKeys](#-archiveKeys)
*   [saveStateToArchive](#-saveStateToArchive)
*   [restoreStateFromArchive](#-restoreStateFromArchive)

*   [Setting Colors](#Setting Colors)

*   [resetColors](#-resetColors)
*   [labelColors](#-labelColors)
*   [unfocusedColors](#-unfocusedColors)
*   [backgrounds](#-backgrounds)
*   [stringColors](#-stringColors)
*   [stringFocusedColors](#-stringFocusedColors)

*   [Setting Geometry and Fonts](#Setting Geometry and Fonts)
...
*   [Inherited instance methods](#Inherited instance methods)
*   [Undocumented instance methods](#Undocumented instance methods)
...
*   [Quick styling with variations on *new:](#Quick styling with variations on *new:)

*   [Drag objects from one tab to another (under cocoa and qt only at the moment):](#Drag objects from one tab to another (under cocoa and qt only at the moment):)

*   [Add, removeAt, insert tabs](#Add, removeAt, insert tabs)

*   [Auto-Archiving Tabs](#Auto-Archiving Tabs)

*   [resize](#resize)

*   [Nest TabbedView2 & use scrolling](#Nest TabbedView2 & use scrolling)

*   [User functions: focus and unfocus](#User functions: focus and unfocus)

*   [Swing Special: focusFrameColor_(color) and unfocusTabs_(bool)](#Swing Special: focusFrameColor_(color) and unfocusTabs_(bool))

*   [Fixed tab widths and \auto tab widths](#Fixed tab widths and \auto tab widths)

*   [Set Font](#Set Font)

*   [Set colors very specifically to your own taste using set methods](#Set colors very specifically to your own taste using set methods)

*   [Adjust padding and curves](#Adjust padding and curves)

*   [Adjust tab height and curves](#Adjust tab height and curves)

*   [Demo](#Demo)

*   [All Features and Parameters](#All Features and Parameters)
